...
RAW_REQUESTS_READ_CNTR = Counter("RAW_REQUESTS_READ_CNTR", "Number of raw requests read from kafka", ["sender_instance",])
UNKNOWN_SOURCE_CNTR = Counter("UNKNOWN_SOURCE_CNTR", "Number raw request with unknown source", ["sender_instance",])
